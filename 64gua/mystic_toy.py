...
HEXAGRAM_MEANINGS = {
    "乾为天": "主动、开创、强势推进。适合行动，但要避免过度自信。",
    "坤为地": "稳定、承载、顺势而为。适合打基础，不适合硬冲。",
    "水雷屯": "事情刚开始会混乱，适合先建立结构，不要急于求成。",
    "山水蒙": "信息不足，需要学习、请教和澄清问题。",
    "水天需": "需要等待时机。现在不是不能做，而是要准备充分。",
    "天水讼": "容易有争执或分歧。适合先讲清规则和边界。",
    "地水师": "需要组织、纪律和团队协作，不适合单打独斗。",
    "水地比": "适合合作、结盟、寻找可靠伙伴。",
    "风天小畜": "已有积累，但力量还不够大。适合小步推进。",
    "天泽履": "行动要谨慎，注意规则、礼节和风险。",
    "地天泰": "上下通顺，局面转好。适合推进，但仍要保持稳健。",
    "天地否": "沟通不畅，局面受阻。适合暂停、观察、修正方向。",
    "天火同人": "适合与人协作，凝聚共识，共同完成目标。",
    "火天大有": "资源较充足，机会较明显。适合把握优势。",
    "地山谦": "保持谦逊，低调推进，反而更容易成功。",
    "雷地豫": "气氛活跃，适合启动和动员，但不要只顾兴奋。",
    "泽雷随": "顺势跟随，调整节奏。不要过度固执。",
    "山风蛊": "旧问题需要清理。适合修复、整理、重构。",
    "地泽临": "机会靠近，适合主动管理和靠近目标。",
    "风地观": "先观察全局，再决定行动。适合调研和复盘。",
    "火雷噬嗑": "有障碍需要突破。适合明确规则、解决卡点。",
    "山火贲": "重视外在呈现和包装，但不要只做表面功夫。",
    "山地剥": "局势削弱，适合保守、防守、减少损耗。",
    "地雷复": "低谷后开始恢复。适合重新启动、小步回归。",
    "天雷无妄": "保持真实和正直，不要乱动或强行制造机会。",
    "山天大畜": "需要积累实力，适合储备资源、暂停冒进。",
    "山雷颐": "注意输入和养成。适合学习、休整、培养能力。",
    "泽风大过": "压力过大，结构可能失衡。适合减负和重新支撑。",
    "坎为水": "困难较多，风险较高。适合谨慎、分步通过。",
    "离为火": "清晰、显现、依附。适合展示成果，也要防止情绪化。",
    "泽山咸": "互动、感应、关系变化。适合沟通和建立连接。",
    "雷风恒": "长期坚持，稳定节奏。适合持续经营，不适合三分钟热度。",
    "天山遁": "适合后退、避让、保存实力，不必硬拼。",
    "雷天大壮": "力量增强，适合推进，但要防止鲁莽。",
    "火地晋": "逐步上升，适合争取曝光、机会和认可。",
    "地火明夷": "光被遮住，适合低调保护自己，不宜锋芒太露。",
    "风火家人": "内部秩序很重要。适合整理团队、家庭或组织结构。",
    "火泽睽": "意见不合，方向分散。适合先解决分歧。",
    "水山蹇": "前路受阻，适合绕路、求助或暂缓。",
    "雷水解": "问题开始松动，适合解除压力、处理遗留问题。",
    "山泽损": "需要减少、取舍、牺牲部分利益以换取平衡。",
    "风雷益": "有增长和帮助。适合扩展、优化和增加投入。",
    "泽天夬": "需要果断决策，清除问题，但要避免冲动。",
    "天风姤": "突然相遇或突发机会。适合谨慎评估，不要被表象带走。",
    "泽地萃": "资源聚集，适合开会、整合、人脉连接。",
    "地风升": "逐步上升，适合长期建设和稳定成长。",
    "泽水困": "资源受限，处境受困。适合节省、忍耐、找突破口。",
    "水风井": "基础资源仍在。适合维护系统、修井、打基础。",
    "泽火革": "适合变革、替换旧制度，但要准备充分。",
    "火风鼎": "新结构成型，适合升级、重组、建立新秩序。",
    "震为雷": "震动、启动、惊醒。适合行动，但要稳住心态。",
    "艮为山": "停止、边界、控制。适合刹车、复盘、设限。",
    "风山渐": "循序渐进，慢慢变好。适合长期推进。",
    "雷泽归妹": "关系或安排不完全稳固。适合谨慎处理承诺。",
    "雷火丰": "发展旺盛，信息很多。适合抓机会，也要防过载。",
    "火山旅": "漂泊、临时状态。适合短期行动，不适合重仓长期承诺。",
    "巽为风": "柔和渗透，适合沟通、影响、慢慢推进。",
    "兑为泽": "喜悦、交流、表达。适合谈判、沟通、宣传。",
    "风水涣": "分散、化解、释放。适合打散僵局、重新组织。",
    "水泽节": "需要节制和规则。适合设预算、设流程、控风险。",
    "风泽中孚": "诚信和信任是关键。适合建立承诺和透明沟通。",
    "雷山小过": "小事可以过，大事要谨慎。适合微调，不适合冒进。",
    "水火既济": "事情接近完成，但越到最后越要小心。",
    "火水未济": "尚未完成，仍有错位。适合继续调整，不要急着收尾。",
}
...
def get_hexagram_meaning(hexagram_name):
    """
    根据卦名返回娱乐性现代解释。
    """
    return HEXAGRAM_MEANINGS.get(
        hexagram_name,
        "暂无解释。这个卦可能还没加入解释库。"
    )
...
def cast_hexagram():
    ...
    print(f"解释：{get_hexagram_meaning(original_info['hexagram_name'])}")
    ...
    print(f"趋势：{get_hexagram_meaning(changed_info['hexagram_name'])}")
